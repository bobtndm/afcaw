...
#-----------------------------------------------------------
                ...
                profile = ki.getProfile()
                text = profile.displayName + "Tohka Yatogami"
                ki.sendText(msg.to, text)
                profile = ki2.getProfile()
                text = profile.displayName + "Miku Izayoi"
                ki2.sendText(msg.to, text)
                profile = ki3.getProfile()
                text = profile.displayName + "Kurumi Tokisaki"
                ki3.sendText(msg.to, text)
                profile = ki4.getProfile()
                text = profile.displayName + "Origami Tobiichi"
...
#-----------------------------------------------
            ...
            elif msg.text.lower() == 'Alferd':
                ki.sendText(msg.to,"Cogan 􀜁􀇔􏿿")
                ki2.sendText(msg.to,"Cina 􀜁􀇔􏿿")
                ki3.sendText(msg.to,"Ganteng 􀜁􀇔􏿿")
                ki4.sendText(msg.to,"Maksimal 􀜁􀇔􏿿")
                ki5.sendText(msg.to,"Tapi dia joblo 􀜁􀇔􏿿")
